import { AlwaysHelpYouData } from "@/constants/data";
...
const AlwaysHelpYou = () => {
  return (
    <Section className={"mt-10 m-5"}>
      {AlwaysHelpYouData.map((item) => {
        return (
          <div
            className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-[6rem] lg:py-16 lg:grid-cols-12 max-lg:flex max-lg:flex-col-reverse"
            key={item.id}
          >
